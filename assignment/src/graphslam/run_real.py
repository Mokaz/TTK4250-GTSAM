...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run factor graph SLAM on the Victoria Park data set.")
    parser.add_argument("--config", type=Path, default=Path("configs/real_default.yaml"))
